<?php
/* Smarty version 3.1.34-dev-7, created on 2025-01-20 16:17:02
  from 'C:\xampp\htdocs\estudio6\templates\datos.html' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.34-dev-7',
  'unifunc' => 'content_678e68ee48c0c4_96447869',
...
function content_678e68ee48c0c4_96447869 (Smarty_Internal_Template $_smarty_tpl) {
...
if (empty($_prefixVariable1)) {?>
                    <div class="form-group float-right">
                        <a class="btn btn-dark btn-lg rounded-pill" onclick="copiar_texto('deudas_alumno')">Detalle de cuota</a>
                    </div>
                    ...
                    <div class="form-group float-right mr-3 ml-2">
                        <div class="form-check">
                            <input <?php if ($_smarty_tpl->tpl_vars['BAJA']->value != 0) {?> checked <?php }?> class="form-check-input" role="button" type="checkbox" name="baja_alumno" id="baja_alumno">
...
" id="id_perfil" class="rounded-circle" height="130" width="130"/>
