<?php
/* Smarty version 3.1.34-dev-7, created on 2026-01-08 15:13:56
  from 'C:\xampp\htdocs\estudio6\templates\datos.html' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.34-dev-7',
  'unifunc' => 'content_695fbba4928684_55229623',
...
function content_695fbba4928684_55229623 (Smarty_Internal_Template $_smarty_tpl) {
...
if (empty($_prefixVariable1)) {?>
                    <div class="form-group float-right">
                        <i class="bi bi-copy" id="copiar_datos" onclick="copiar_texto('deudas_alumno','afavor_alumno')" style="font-size: xx-large;"></i>
                    </div>
                    <div class="form-group float-right mr-4">
                        <div class="form-check">
                            ...
                            <i class="bi bi-calendar-check ml-3" role="button" onclick="document.querySelector('#afavor_alumno').style.display = 'block'" style="font-size: xx-large;"></i>
                        </div>
                    </div>
                <?php }?>
                <div class="form-group float-right mr-3 ml-2">
                    <div class="form-check">
                        ...
                        <p class="form-check-label mb-1" id="info_baja" <?php if ($_smarty_tpl->tpl_vars['BAJA']->value !== null) {?>style="padding:4px;background:#f9b8b8;border-radius:7px;font-size:12px;"<?php } else { ?>style="font-size: 12px;"<?php }?>>
                        ...
                        <p class="form-check-label" style="font-size: 12px;padding: 4px;background: #beffbe;border-radius: 7px;">Alta: <?php echo smarty_modifier_date_format($_smarty_tpl->tpl_vars['ALTA']->value,'%d/%m/%Y');?>
</p>
                    </div>
                </div>
                <?php ob_start();
...
if (empty($_prefixVariable2)) {?>
                    <div class="form-group col-md-12 d-flex justify-content-center">
                        <div class="float-left">
                            <label>A pagar</label>
                            <input type="text" id="valor" readonly="true" name="alumno" class="form-control col-md-6 text-center f-10" value="$<?php echo number_format($_smarty_tpl->tpl_vars['VALOR']->value,0,",",".");?>
">
                        </div>
                        <div class="ml-3 float-left">
                            <label>Combo</label>
                            <input type="text" id="combo" readonly="true" class="form-control col-md-6 text-center f-10" value="$<?php echo number_format($_smarty_tpl->tpl_vars['COMBO']->value,0,",",".");?>
">
                        </div>
                        <div class="ml-3 float-left">
