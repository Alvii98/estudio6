<?php
/* Smarty version 3.1.34-dev-7, created on 2026-02-23 17:57:05
  from 'C:\xampp\htdocs\estudio6\templates\index.html' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.34-dev-7',
  'unifunc' => 'content_699c86e1660563_56026265',
...
function content_699c86e1660563_56026265 (Smarty_Internal_Template $_smarty_tpl) {
...
<body>
    ...
    <div class="container border border-color rounded mb-4 text-body">
        <div class="row d-flex justify-content-center">
            ...
            <div class="col-md-12 d-flex justify-content-center">
                <select class="form-control ml-2 col-md-3 mt-3" onchange="acceso_inscripciones(this.value)">
                    <option <?php if ($_smarty_tpl->tpl_vars['INSCRIPCION_OP']->value == 1) {?>selected<?php }?> value="1">Inscripciones abiertas</option>
                    <option <?php if ($_smarty_tpl->tpl_vars['INSCRIPCION_OP']->value == 0) {?>selected<?php }?> value="0">Inscripciones cerradas</option>
                </select>
            </div>
            <div class="col-md-10 d-flex justify-content-center param-busqueda">
                ...
                <input type="text" id="edad" placeholder="Edad" class="form-control ml-2 col-md-2 mt-3">
                <input type="button" id="deudores" class="form-control ml-2 col-md-2 mt-3" value="Deudores">
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
            ...
            <div class="col-md-12 text-center">
                ...
                <div class="col-md-12 d-flex justify-content-center">
                    <select class="form-control col-md-4" id="estadistica">
                        <option>Deudas totales</option>
                    </select>
                </div>
                <label id="cant_resp"></label>
                <div class="scroll mb-3">
                    <table class="table table-bordered text-body" id="tabla_alumnos">
                        <thead align="center">
                            <tr>
                        ...
                        <tbody>
                            <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['DEUDAS_TOTALES']->value, 'value');
$_smarty_tpl->tpl_vars['value']->do_else = true;
if ($_from !== null) foreach ($_from as $_smarty_tpl->tpl_vars['value']->value) {
$_smarty_tpl->tpl_vars['value']->do_else = false;
?>
                                <?php if (!empty($_smarty_tpl->tpl_vars['value']->value['total_deuda'])) {?>
                                <tr onclick="alumno_id('<?php echo $_smarty_tpl->tpl_vars['value']->value['id'];?>
','<?php echo $_smarty_tpl->tpl_vars['value']->value['apellido'];?>
')">
                                    <td><?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['value']->value['nombre'], 'utf8_encode');?>
</td>
                                    <td>$<?php echo number_format($_smarty_tpl->tpl_vars['value']->value['total_deuda'],0,",",".");?>
</td>
                                </tr>
                                <?php }?>
                            <?php
