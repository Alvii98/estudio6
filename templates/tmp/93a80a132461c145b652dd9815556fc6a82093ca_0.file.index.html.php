...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  ...
  'unifunc' => 'content_677eb9f8b91155_95792875',
...
function content_677eb9f8b91155_95792875 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <div class="container border border-color rounded mb-4 text-body">
        <div class="row d-flex justify-content-center">
            <div class="col-md-12 d-flex justify-content-center">
                ...
                <div class="col-md-3 boton-cargar" onclick="location.href='vinculos.php'">Vinculos familiares</div>
